...
const NodeApiCourse=()=>{
  const [showForm, setShowForm] = useState(false);
    ...
    return (
      ...
      >
       <h1 style={{color:'blue',margin:'10px'}} >Node.js Api Architecture</h1>
...
<h2 style={{color: '#4a154b', marginTop: '40px'}}>Course Fee Calculator</h2>
<div style={{backgroundColor: '#f9f5ff',
          border: '1px solid #e9d5ff',
          borderRadius: '8px',
          padding: '20px',}}>
            <p style={{color: '#555', marginTop: 0, marginBottom: '16px', fontSize: '14px' }}>
             Choose a payment plan to see your breakdown cost
              </p>
