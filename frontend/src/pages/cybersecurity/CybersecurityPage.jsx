    ...
    <div style={{ padding: '40px', maxWidth: '1100px', margin: '0 auto', fontFamily: 'Segoe UI, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginTop: '20px' }}>
        ...
        <div style={{ backgroundColor: '#fff', border: '1px solid #e9d5ff', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
          ...
          <p style={{ color: '#555' }}>Comprehensive hands-on training module for Ethical Hacking & Penetration Testing. Includes interactive lab projects and certification preparation.</p>
        ...
        <div style={{ backgroundColor: '#fff', border: '1px solid #e9d5ff', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
          ...
          <p style={{ color: '#555' }}>Professional skill-building course covering Network Security & Defense Certification. Designed for beginners and intermediate learners.</p>
          <button style={{ backgroundColor: '#4a154b', color: '#fff', border: 'none', padding: '8px 16px', borderRadius: '4px', cursor: 'pointer', width: '100%' }}>Explore Course</button>
        </div>

        <div style={{ backgroundColor: '#fff', border: '1px solid #e9d5ff', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
          <h3 style={{ color: '#4a154b' }}>3. Corporate Cybersecurity Training</h3>
          <p style={{ color: '#555' }}>Advanced career bootcamp module for Corporate Cybersecurity Training with real-world industry portfolio projects.</p>
          <button style={{ backgroundColor: '#4a154b', color: '#fff', border: 'none', padding: '8px 16px', borderRadius: '4px', cursor: 'pointer', width: '100%' }}>Explore Course</button>
        </div>
